...
def ppml_estimate(df):
    ...
    beta_dist = -beta_hat[3]
    
    return beta_hat, beta_dist, result


print("\nRunning PPML estimation...")

beta_ppml, beta_dist_ppml, ppml_result = ppml_estimate(full_df)

print(f"PPML Results:")
print(f"  Distance exponent β = {beta_dist_ppml:.3f}")
print(f"  Converged: {ppml_result.success}")
